...
# multiple of vanilla's density, but a bounded one — KURONAMI333 called 1/8 "too many" and
...
def check_pool(rel: str, obj: dict) -> int:
    ...
    # A pool at irregularity 0 is a compass circle, which is what KURONAMI333 rejected. The
